...
if __name__ == "__main__":
    ...
    for con in CONFIG:
        ...
        if limpieza == 'olas':
            ...
            df = transformarCorrientes(df, v_bins)
        df.to_excel(f'out/data_limpia_{adcp}.xlsx')
        ...
        with PdfPages(pdf_path) as pdf:
            ...
            try:
                ...
                fig_dir_title.text(0.5, 0.6, hs_title_text, ha='center', va='center', fontsize=22, weight='bold')
